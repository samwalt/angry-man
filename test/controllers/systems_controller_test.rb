...
class SystemsControllerTest < ActionController::TestCase
  ...
  test "should create system" do
    assert_difference('System.count') do
      post :create, system: { angryman_id: @system.angryman_id, description: @system.description, name: @system.name, type: @system.type }
    end
  ...
  test "should update system" do
    patch :update, id: @system, system: { angryman_id: @system.angryman_id, description: @system.description, name: @system.name, type: @system.type }
    assert_redirected_to system_path(assigns(:system))
  end
